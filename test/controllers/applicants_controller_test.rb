...
class ApplicantsControllerTest < ActionController::TestCase
  ...
  test "should create applicant" do
    assert_difference('Applicant.count') do
      post :create, applicant: { body: @applicant.body, entry_id: @applicant.entry_id, user_id: @applicant.user_id }
    end
  ...
  test "should update applicant" do
    patch :update, id: @applicant, applicant: { body: @applicant.body, entry_id: @applicant.entry_id, user_id: @applicant.user_id }
    assert_redirected_to applicant_path(assigns(:applicant))
  end
